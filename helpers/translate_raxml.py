# comes from the SEPP repo from the Mirarab lab
# translates RAxML v8 info file to RAxML v7 info file for nucleotide data
#!/bin/env python

import sys

def translate_raxml(src, dst):
    raxmlinfo = '''
    ...
    with open(src, 'r') as fh: ls = fh.readlines()
